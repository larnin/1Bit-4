...
public abstract class QuestSubObjectiveViewBase
{
    ...
    public static QuestSubObjectiveViewBase Create(QuestSystemNodeObjective node, QuestSubObjectiveBase subObjective)
    {
        ...
        if (subObjective is QuestSubObjectiveSpawnCanvasObject)
            return new QuestSubObjectiveViewSpawnCanvasObject(node, subObjective as QuestSubObjectiveSpawnCanvasObject);
        ...
        if (subObjective is QuestSubObjectiveSetAllBuildingsUnlocked)
            return new QuestSubObjectiveViewSetAllBuildingsUnlocked(node, subObjective as QuestSubObjectiveSetAllBuildingsUnlocked);
